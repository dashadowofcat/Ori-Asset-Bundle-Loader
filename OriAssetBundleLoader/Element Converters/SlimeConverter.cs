...
public class SlimeConverter : ElementConverter
{
    public override void ConvertElement(GameObject Asset)
    {
        GameObject slime = GameObject.Instantiate(PrefabCachingManager.GetPrefab("Slime"), Asset.transform); ;

        slime.transform.localPosition = Vector3.zero;

        SlugPlaceholder PlaceHolder = slime.GetComponent<SlugPlaceholder>();
