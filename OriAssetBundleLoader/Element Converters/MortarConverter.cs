...
public class MortarConverter : ElementConverter
{
    public override void ConvertElement(GameObject Asset)
    {
        GameObject mortar = GameObject.Instantiate(PrefabCachingManager.GetPrefab("Mortar"), Asset.transform); ;


        mortar.transform.localPosition = Vector3.zero;

        MortarPlaceholder PlaceHolder = mortar.GetComponent<MortarPlaceholder>();

        PlaceHolder.CanTurnAround = true;
